...
cp target/universal/ebookey-0.1.0-SNAPSHOT.zip  /tmp
cd /tmp
unzip ebookey-0.1.0-SNAPSHOT.zip
mv ebookey-0.1.0-SNAPSHOT /opt/ebookey
...
cd /tmp
unzip ebookey-0.1.0-SNAPSHOT.zip
cp /opt/ebookey/conf/application.conf /tmp/ebookey-0.1.0-SNAPSHOT/conf
sudo service ebookey stop
rm -rf /opt/ebookey/*
mv /tmp/ebookey-0.1.0-SNAPSHOT/* /opt/ebookey/
